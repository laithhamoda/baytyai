...
export const LANGUAGE_SUPPORT_OPTIONS = ['arabic_only', 'english_only', 'bilingual'] as const;
...
export const step3Schema = z.object({
  service_modules: z.array(z.enum(SERVICE_MODULES)).min(1, 'Select at least one service module'),
