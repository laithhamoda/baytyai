...
export default function ArabicLanding() {
  return (
    ...
    >
      ...
      >
        تجمع بيتي دورة حياة مشروع البناء بالكامل — أصحاب مصلحة موثّقون، اعتمادات منظّمة، وسوق موثوق
        — على منصة واحدة معتمدة في الإمارات والخليج. تُطلق الواجهة العربية الكاملة في الربع الأخير
        من 2026.
      </p>
