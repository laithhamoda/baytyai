...
export default function LoginClient() {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ width: "40px", height: "0.5px", backgroundColor: GOLD, margin: "0 auto 32px" }} />
        <h1
          style={{
            fontFamily: serif,
            fontWeight: 300,
        ...
        {step === "email" ? (
          <form onSubmit={sendCode} style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
            <div>
          ...
          <form onSubmit={verifyCode} style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
            <div>
