...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://www.baytyai.com/solutions/owners',
    },
  ],
};
        ...
        capabilities={[
          {
            ...
            body: 'Create and manage unlimited projects with a 9-stage lifecycle tracker.',
          },
          {
            name: 'Verified Team Assembly',
            body: 'Assemble your verified team — invite, check credentials, assign roles in one step.',
          },
          {
            name: 'Decisions From Anywhere',
            body: 'Approve, reject, and escalate decisions from any device with a full audit trail.',
          },
          {
            name: 'Portfolio Analytics',
            body: 'Track progress, spend, and bottlenecks across all active projects in real time.',
          },
          {
            name: 'Document Oversight',
            body: 'Maintain a single source of truth for drawings, contracts, and site records.',
          },
          {
            name: 'Marketplace Access',
            body: 'Source verified professionals and properties within the same authorised workspace.',
          },
        ]}
      />
    </>
