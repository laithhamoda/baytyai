...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Suppliers", item: "https://www.baytyai.com/solutions/suppliers" },
  ],
};
  ...
  return (
    <>
      ...
      <RoleDetail
        ...
        capabilities={[
          { name: "Verified Listing", body: "List your catalogue and credentials in a marketplace owners and contractors trust." },
          { name: "Structured Requests", body: "Receive itemised material and equipment requests tied to specific projects." },
          { name: "Quoting", body: "Submit and track quotes with a clear, recorded approval status." },
          { name: "Protected Payments", body: "Settle through milestone-based payments with a complete transaction record." },
          { name: "Project Discovery", body: "Get matched to active GCC projects that need your product categories." },
          { name: "Document Access", body: "Access the specifications and schedules relevant to your supply scope." },
        ]}
      />
    </>
  );
