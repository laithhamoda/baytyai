        ...
        capabilities={[
          {
            ...
            body: 'Build your verified professional profile — government-linked credential check in 24 hours.',
          },
          {
            name: 'Get Discovered',
          ...
          },
          {
            ...
            body: 'Receive precise, structured scope documents for every assignment you take on.',
          },
          {
            name: 'Document Access',
            body: 'Access the drawings, specifications, and contracts relevant to your scope.',
          },
          {
