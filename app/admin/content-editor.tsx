  ...
  return (
    <div>
              ...
              <div key={f.key} style={{ marginBottom: '28px' }}>
                ...
                {f.type === 'image' && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    ...
                    />
                    {uploading === f.key && (
                      <span style={{ fontFamily: mono, fontSize: '10px', color: GOLD }}>
                        Uploading…
                      </span>
                    )}
                    {state[f.key] && (
      ...
      >
        ...
        {saved && (
          <span style={{ fontFamily: mono, fontSize: '11px', color: GOLD }}>
            Saved and published.
          </span>
        )}
        {error && (
          <span role="alert" style={{ fontFamily: sans, fontSize: '13px', color: '#C87878' }}>
            {error}
          </span>
        )}
      </div>
