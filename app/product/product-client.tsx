    ...
    >
      ...
      >
        ...
        <motion.div {...fadeUp(0.12)} style={{ order: reverse ? 1 : 2 }}>
          <span style={{ ...mono, fontSize: "44px", color: "rgba(201,168,76,0.3)", fontWeight: 300 }}>
            0{index}
          </span>
          <div
            style={{
        ...
        {PROJECTS.map((p) => (
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
              <span style={{ fontFamily: sans, fontWeight: 500, fontSize: "12px", color: "#F8F6F1" }}>{p.name}</span>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <span style={{ ...mono, fontSize: "8px", color: "rgba(248,246,241,0.45)" }}>{p.team} TEAM</span>
              <span style={{ ...mono, fontSize: "8px", color: p.approvals ? GOLD : "rgba(248,246,241,0.45)" }}>
                {p.approvals} PENDING
              </span>
            </div>
            {p.risk && (
              <div style={{ marginTop: "10px", borderTop: "0.5px solid rgba(201,168,76,0.2)", paddingTop: "8px" }}>
  ...
  return (
    <Frame>
        ...
        {DOCS.map((d) => (
          ...
          >
            <span style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <span style={{ fontFamily: sans, fontWeight: 300, fontSize: "13px", color: "#F8F6F1" }}>{d.name}</span>
            </span>
      ...
      >
        ...
        <div>
          <p style={{ fontFamily: sans, fontWeight: 500, fontSize: "13px", color: GOLD }}>Bayty Verified</p>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
              ...
              >
                {a.done ? (
                  ...
                  <span style={{ ...mono, fontSize: "9px", color: "rgba(248,246,241,0.4)" }}>{i + 1}</span>
                )}
              </span>
              {i < APPROVALS.length - 1 && (
                <span style={{ width: "0.5px", flex: 1, minHeight: "22px", backgroundColor: "rgba(201,168,76,0.25)" }} />
              )}
            </div>
            {/* content */}
            <div style={{ paddingBottom: "18px", flex: 1 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontFamily: sans, fontWeight: 500, fontSize: "13px", color: "#F8F6F1" }}>{a.name}</span>
                {a.pending && (
                  <button
                    style={{
                      ...mono,
              ...
              <p style={{ fontFamily: sans, fontWeight: 300, fontSize: "11px", color: "rgba(248,246,241,0.5)" }}>{a.role}</p>
              <p style={{ ...mono, fontSize: "9px", color: a.pending ? GOLD : "rgba(248,246,241,0.4)", marginTop: "3px" }}>
                {a.time}
              </p>
            </div>
          </div>
...
const FILES = [
  { v: "v4", name: "Tower A — MEP Drawings", by: "M. Farouk", date: "2 Jun 2026", status: "Approved", current: true },
  { v: "v3", name: "Tower A — MEP Drawings", by: "M. Farouk", date: "28 May 2026", status: "Superseded", current: false },
  { v: "v2", name: "Tower A — MEP Drawings", by: "S. Haddad", date: "21 May 2026", status: "Superseded", current: false },
];
  ...
  return (
    <Frame>
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        {FILES.map((f) => (
          ...
          >
            ...
            <span style={{ ...mono, fontSize: "10px", color: f.current ? GOLD : "rgba(248,246,241,0.5)" }}>{f.v}</span>
            <div style={{ flex: 1 }}>
              <p style={{ fontFamily: sans, fontWeight: 400, fontSize: "12px", color: "#F8F6F1" }}>{f.name}</p>
              <p style={{ ...mono, fontSize: "8px", color: "rgba(248,246,241,0.45)", marginTop: "2px" }}>
                {f.by} · {f.date}
              </p>
            </div>
      ...
      <div style={{ textAlign: "right", marginTop: "12px" }}>
        <span style={{ ...mono, fontSize: "9px", color: GOLD, borderBottom: `0.5px solid ${GOLD}`, paddingBottom: "1px", cursor: "pointer" }}>
          View history
        </span>
      </div>
    </Frame>
...
const PROS = [
  ...
  { initial: "S", role: "Structural Consultant", loc: "Abu Dhabi, UAE", projects: 27, rating: "4.8" },
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <span style={{ fontFamily: sans, fontWeight: 500, fontSize: "12px", color: "#F8F6F1" }}>{p.role}</span>
                <ShieldCheck size={12} color={GOLD} strokeWidth={2} />
              </div>
              <p style={{ ...mono, fontSize: "8px", color: "rgba(248,246,241,0.45)", marginTop: "3px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "5px", flexShrink: 0 }}>
              <button style={{ ...mono, fontSize: "8px", color: NAVY, backgroundColor: GOLD, border: "none", padding: "5px 10px", cursor: "pointer" }}>
                Shortlist
              </button>
              <button style={{ ...mono, fontSize: "8px", color: GOLD, backgroundColor: "transparent", border: `0.5px solid ${GOLD}`, padding: "5px 10px", cursor: "pointer" }}>
                Contact
              </button>
            </div>
          </div>
  ...
  return (
    <div style={{ backgroundColor: NAVY }}>
      ...
      <section style={{ maxWidth: "1200px", margin: "0 auto", padding: "160px 24px 80px" }}>
        <motion.p {...fadeUp(0)} style={{ ...mono, fontSize: "11px", color: GOLD, marginBottom: "24px" }}>
          The Platform
        </motion.p>
        <motion.h1
          {...fadeUp(0.08)}
        ...
        >
          From verified onboarding to structured approvals and a trusted marketplace — see
          exactly how Bayty runs a GCC construction project end to end.
        </motion.p>
      </section>
