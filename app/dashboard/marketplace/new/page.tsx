...
export default async function NewInquiryPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl p-2">
      ...
      <h1 className="mb-2 font-sans text-2xl font-semibold text-ink-100">Post an inquiry</h1>
      <p className="mb-8 font-sans text-sm text-ink-300">
        Describe what you need. Verified organizations can browse it and submit quotations.
      </p>

      {!verified ? (
        <p className="border border-signal-500/40 bg-ink-900 px-4 py-3 font-sans text-sm text-ink-300">
