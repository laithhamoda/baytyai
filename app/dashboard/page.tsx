  ...
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-display text-foreground text-2xl font-semibold">Projects</h1>
          <p className="text-muted-foreground mt-1 text-sm">Manage your project intake requests</p>
        </div>
      ...
      {/* Empty state */}
      {projects.length === 0 && (
        <div className="border-border bg-card flex flex-col items-center justify-center rounded-sm border border-dashed py-20 text-center">
          <FolderPlus size={36} className="text-muted-foreground/50 mb-4" />
          ...
          <Button asChild className="mt-6" size="sm">
            <Link href="/dashboard/projects/new">Start a new project</Link>
          </Button>
        </div>
      )}
