    ...
    <div style={{ backgroundColor: "#0A1628", minHeight: "100vh", padding: "120px 48px" }}>
      ...
      >
        ...
        <div style={{ paddingTop: "48px" }}>
          ...
          >
            Corporate, white-label, and government accounts for GCC construction
            and real estate portfolios. Tell us about your requirements and our
        ...
        >
          <AnimatePresence mode="wait">
            {submitted ? (
              ...
              >
                <span style={{ display: "block", width: "40px", height: "0.5px", backgroundColor: "#C9A84C" }} />
                <p
                  style={{
                    fontFamily: "var(--font-display, 'Cormorant Garamond', Georgia, serif)",
                    fontStyle: "italic",
                ...
                >
                  Thank you. Our enterprise team will be in touch within one
                  business day.
                </p>
                <span style={{ display: "block", width: "40px", height: "0.5px", backgroundColor: "#C9A84C" }} />
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <input id="fullName" name="fullName" type="text" required value={values.fullName} onChange={handleChange} placeholder="Khalid Al Rashid" style={fieldBase} />
                </div>

                <div>
                  <label htmlFor="organisation" style={labelStyle}>Organisation</label>
                  <input id="organisation" name="organisation" type="text" required value={values.organisation} onChange={handleChange} placeholder="Government entity or company" style={fieldBase} />
                </div>

                <div>
                  <label htmlFor="workEmail" style={labelStyle}>Work Email</label>
                  <input id="workEmail" name="workEmail" type="email" required value={values.workEmail} onChange={handleChange} placeholder="khalid@organisation.ae" style={fieldBase} />
                </div>

                <div>
                  <label htmlFor="enquiryType" style={labelStyle}>Enquiry Type</label>
                  <select
                    id="enquiryType"
                    name="enquiryType"
                    required
