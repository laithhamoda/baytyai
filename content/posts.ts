...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    body: [
      {
        type: 'p',
        text: 'Awarding work to an unverified contractor is one of the most expensive mistakes a developer can make. In Dubai, a valid trade licence, the correct activity classification, and current professional credentials are the difference between a defensible project and a dispute waiting to happen. This guide walks through how to verify a contractor properly in 2026.',
      },
      { type: 'h2', text: 'Step 1 — Confirm the trade licence' },
      {
        type: 'p',
        text: 'Every legitimate contractor operating in Dubai holds a trade licence issued by the relevant economic department or free zone authority. Confirm the licence number, the legal name, and — critically — that the licensed activities actually cover the scope of work you intend to award. A licence for general trading does not authorise structural works.',
      },
      { type: 'h2', text: 'Step 2 — Check professional credentials' },
      {
        type: 'p',
        text: 'Beyond the company licence, the individuals doing the work should hold relevant professional certifications. For engineering and MEP scopes, verify the qualifications of the named engineers, not just the company. Credentials should be current and matched to the discipline.',
      },
      { type: 'h2', text: 'Step 3 — Validate identity' },
      {
        type: 'p',
        text: 'Tie the company and its representatives to verifiable identity documents such as the Emirates ID. This prevents the common failure mode where a credentialed entity subcontracts informally to an unverified party who never appears on paper.',
      },
