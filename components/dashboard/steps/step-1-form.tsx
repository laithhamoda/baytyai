        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>VAT / TRN Number <span className="text-muted-foreground">(optional)</span></FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="Head of PMO" {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="+966501234567" {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )}
            />
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Corporate Email</FormLabel>
                  <FormControl><Input type="email" placeholder="ceo@company.com" {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )}
            />
