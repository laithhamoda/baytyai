...
const STEPS: Step[] = [
  ...
  { Icon: CreditCard, body: "Appear in every search matching your specialism. Payments protected by escrow." },
];
...
export default function MarketplaceJoin() {
  return (
    <section style={{ backgroundColor: "#0A1628", padding: "120px 0", borderTop: "0.5px solid rgba(201,168,76,0.15)" }}>
