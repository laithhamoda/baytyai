          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              <p className="font-sans text-base leading-relaxed text-ink-300">
                ...
                in Facilities Management, Construction, and infrastructure mega-projects. His
                engineering background spans mechanical and HVAC delivery, and he holds a certified
                BTEC evaluator role teaching engineering subjects.
              </p>
              <p className="font-sans text-base leading-relaxed text-ink-300">
                Laith publishes operator-grade project-control prompts on LinkedIn and builds the AI
                workflows that BaytyAI deploys into live contracts. He operates in Arabic, English,
                and French.
              </p>
            </div>
