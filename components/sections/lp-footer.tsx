...
const NAV_LINKS: NavLink[] = [
  ...
  { label: 'Founder', href: siteConfig.founder.linkedin, external: true },
];

export default function LpFooter() {
  const year = new Date().getFullYear();
  return (
    <footer id="footer" className="border-t border-ink-700 bg-ink-950 py-16">
      <Container>
        <div className="flex flex-col gap-12 md:flex-row md:gap-24">
          {/* Brand */}
          <div className="flex flex-col gap-4 md:max-w-[240px]">
            <p className="font-sans text-lg font-semibold text-ink-100">BaytyAI</p>
