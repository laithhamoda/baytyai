...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'text-muted-foreground h-12 px-4 text-start align-middle text-xs font-medium uppercase tracking-wider [&:has([role=checkbox])]:pe-0',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn('text-foreground p-4 align-middle [&:has([role=checkbox])]:pe-0', className)}
    {...props}
  />
));
